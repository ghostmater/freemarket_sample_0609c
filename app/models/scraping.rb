...
# class Scraping
#   def self.get_links
#     records = ChildCategory.all
#
#     records.each do |record|
#       puts "{name: '#{record.name}', categories_id: #{record.categories_id}},"
#     end
#   end
# end
...
# class Scraping
#   def self.get_links
#     records = GrandChildCategory.all
#
#     records.each do |record|
#       puts "{name: '#{record.name}', child_categories_id: #{record.child_categories_id}},"
#     end
#   end
# end
